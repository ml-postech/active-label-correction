...
for name in names:
    parts = name.split('.')
    save_root_path = '/hdd/hdd2/khy/temp/active-label-correction/DeepLabV3Plus-Pytorch/masks/' + parts[0] + parts[1]
    os.makedirs(save_root_path, exist_ok=True)

    pixel_path = '/hdd/hdd2/khy/temp/active-label-correction/DeepLabV3Plus-Pytorch/acquisition/cil_pixel.pkl'    
    pixel_dict = np.load(pixel_path, allow_pickle=True)

    pkl_path = '/hdd/hdd2/khy/temp/active-label-correction/DeepLabV3Plus-Pytorch/acquisition/' + name
